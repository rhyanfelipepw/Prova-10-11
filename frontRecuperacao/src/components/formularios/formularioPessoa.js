    ...
    <div className="containerFormLarge">
      <div className="paddingContainer">
        <form onSubmit={onSubmit}>
          ...
          <br />
          <br />
          <h3 className="title" >CEP Comercial</h3>
          <input
            onChange={(event) => setCepCom(event.target.value)}
            type="number"
            name="name"
          />
          <h3 className="title">Numero Comercial</h3>
          <input
            onChange={(event) => setNumeroCom(event.target.value)}
            type="number"
            name="name"
          />
          <h3 className="title">Complemento Comercial</h3>
          <input
          ...
          /><br/>
          <br/>
          <h3 className="title">CEP Residencial</h3>
          <input
            onChange={(event) => setCepRes(event.target.value)}
            type="number"
            name="name"
          />
          <h3 className="title">Numero Residencial</h3>
          <input
            onChange={(event) => setNumeroRes(event.target.value)}
            type="number"
            name="name"
          />
          <h3 className="title">Complemento Residencial</h3>
          <input
            onChange={(event) => setCompleRes(event.target.value)}
            type="text"
            name="name"
          />
          <button name="pesquisar">Click me</button>
        </form>
      </div>
    </div>
  );
